		...
		true->
			case guild_manager:contribute(guild_util:get_guild_id(),get(roleid),?MONEY_SILVER,MoneyCount) of
				ok->
					...
					achieve_op:achieve_update({contribution},[0],trunc(MoneyCount/3000));%%@@wb20130407更新捐献帮贡成就
...
contribute(Contribute)->
	...
	if
		HasRight->
			achieve_op:achieve_update({contribution},[0],Contribute),%%@@20130407更新任务帮贡成就
