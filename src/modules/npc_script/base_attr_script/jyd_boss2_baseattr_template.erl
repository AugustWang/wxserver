...
%% Author: zhanglei
%% Created: 2011-12-27
%% Description: TODO: Add description to jyd_boss2_baseattr_template
-module(jyd_boss2_baseattr_template).
...
get_maxhp(Level,OldValue)->
	erlang:trunc(28.8934*Level*Level-1893.041*Level+32174.6369).
...
get_minmoney(Level,OldValue)->
	erlang:trunc(9.7195*Level+9.8431).
